...
app.post('/api/auth/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, auth_controller_1.Authregister)(req.body)];
            case 1:
                result = _a.sent();
                res.status(200).json({ message: result.message }); // Si tout se passe bien, retournez un code de statut 200 avec un message de succès
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                if (error_1.name == 'UserExistsError') {
